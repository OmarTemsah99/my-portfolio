...
const AboutPage = () => {
  ...
  // Updated stats with more humor and organized in rows
  const statsRows = [
        ...
        <Fade in={isVisible} timeout={1000}>
          <Box sx={{ textAlign: "center", mb: { xs: 6, md: 8 } }}>
            ...
            <Typography
              ...
              building delightful, scalable web apps—front to back and
              everything in between. I specialize in React, Next.js, TypeScript,
              Node.js, and occasionally bribe MongoDB with coffee to keep it
              cooperative. ☕
              <br />
              <br />
              Once upon a time, I dabbled in the mystical arts of Embedded
              Systems, C/C++, and IoT—so I still know how to make LEDs blink in
              Morse code when JavaScript fails. ✨📟
            </Typography>
            ...
            <Typography
              ...
              These days, I&apos;m all about clean code, sleek UIs that
              don&apos;t make users cry, and APIs that actually respond (and
              don&apos;t ghost you 👻). Always learning, always building,
              occasionally googling &quot;how to center a div&quot; just for
              nostalgia. Let&apos;s build cool stuff and break things
              (responsibly). 🚀
            </Typography>
          </Box>
        </Fade>

        {/* Enhanced Stats Section with Continuous Sliding Animation */}
        ...
        <Fade in={isVisible} timeout={2000}>
          <Box
            ...
            <Typography
              ...
              gadget, or a 3D prototype that wows — I&apos;m here to help bring
              it to life (with code, not just caffeine ☕). Let&apos;s team up
