          ...
          <Slide direction="up" in={isVisible} timeout={1500}>
            <Box sx={{ mb: 6, maxWidth: "800px", mx: "auto" }}>
              ...
              <Typography
                ...
                <br />
                From embedded systems that talk to each other (they&apos;re
                quite chatty) to React apps that make users go &quot;Wow!&quot;,
                I craft digital experiences that are both functional and
                delightfully smooth.
                <br />
                <Box
                  component="span"
